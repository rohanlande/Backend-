...
const registerUser = asyncHandler(async (req, res) => {
  ...
  // THis new snippet for cover image is written for we dont want compalsory cover image so thats why
  ...
  // removes some imp data that we dont want to send to user in a json responce
